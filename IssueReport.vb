...
Public Class IssueReport
    ...
    Private Sub IssueReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        Try
            If rbtAll.Checked = True Then
                ...
                IssueReport1.getValue1(cmbBookName.Text)
            ElseIf rbtParticular.Checked = True Then

                'AddmissionReport1.getFilterCname(cmbCustomer.Text)
                IssueReport1.getValue(cmbBookName.Text)
                'Me.Close()
                'AddmissionReport1.Show()
            ElseIf rbtSelect.Checked = True Then
                'AddmissionReport1.getFilterCname(cmbCustomer.Text)
                IssueReport1.getValue2(cmbBookName.Text, DateTimePicker1.Text)
                'Me.Close()
                'AddmissionReport1.Show()
            End If
